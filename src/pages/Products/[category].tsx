...
const CategoryProducts = () => {
  ...
  const getSubcategories = (category: string | undefined): Subcategory[] => {
    switch (category) {
      case 'accessories':
        return [
          { id: 'hair', name: 'Hair Accessories', nameKr: '헤어 악세서리', nameCn: '发饰', nameJp: 'ヘアアクセサリー', icon: <ShoppingBag className="w-4 h-4" /> },
          { id: 'necklaces', name: 'Necklaces', nameKr: '목걸이', nameCn: '项链', nameJp: 'ネックレス', icon: <Gem className="w-4 h-4" /> },
          { id: 'rings', name: 'Rings', nameKr: '반지', nameCn: '戒指', nameJp: 'リング', icon: <CircleDot className="w-4 h-4" /> },
          { id: 'brooches', name: 'Brooches', nameKr: '브로치', nameCn: '胸针', nameJp: 'ブローチ', icon: <Heart className="w-4 h-4" /> },
          { id: 'earrings', name: 'Earrings', nameKr: '귀걸이', nameCn: '耳环', nameJp: 'イヤリング', icon: <CircleDashed className="w-4 h-4" /> },
        ];
      case 'diy-parts':
        return [
      ...
      case 'fabric-materials':
        return [
          { id: 'cotton', name: 'Cotton Fabric', nameKr: '면 원단', nameCn: '棉布', nameJp: '綿生地', icon: <Shirt className="w-4 h-4" /> },
          { id: 'linen', name: 'Linen Fabric', nameKr: '리넨 원단', nameCn: '亚麻布', nameJp: 'リネン生地', icon: <Shirt className="w-4 h-4" /> },
          { id: 'silk', name: 'Silk Fabric', nameKr: '실크 원단', nameCn: '丝绸', nameJp: 'シルク生地', icon: <Shirt className="w-4 h-4" /> },
          { id: 'embroidered', name: 'Embroidered Fabric', nameKr: '자수 원단', nameCn: '刺绣布料', nameJp: '刺繍生地', icon: <Shirt className="w-4 h-4" /> },
        ];
      case 'gift-packaging':
        return [
          { id: 'gift-boxes', name: 'Gift Boxes', nameKr: '선물 상자', nameCn: '礼品盒', nameJp: 'ギフトボックス', icon: <Gift className="w-4 h-4" /> },
          ...
          { id: 'pouches', name: 'Fabric Pouches', nameKr: '원단 파우치', nameCn: '布袋', nameJp: '布製ポーチ', icon: <PackageOpen className="w-4 h-4" /> },
        ];
      case 'dongdaemun-accessories':
      case 'namdaemun-accessories':
        return [
          { id: 'hair', name: 'Hair Accessories', nameKr: '헤어 악세서리', nameCn: '发饰', nameJp: 'ヘアアクセサリー', icon: <ShoppingBag className="w-4 h-4" /> },
          { id: 'jewelry', name: 'Jewelry', nameKr: '주얼리', nameCn: '珠宝', nameJp: 'ジュエリー', icon: <Gem className="w-4 h-4" /> },
          { id: 'bags', name: 'Bags', nameKr: '가방', nameCn: '包', nameJp: 'バッグ', icon: <ShoppingBag className="w-4 h-4" /> },
        ];
      default:
        return [];
    }
